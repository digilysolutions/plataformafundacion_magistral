...
<h1>Resolución de ITEMS PRUEBAS-TIEMPO</h1>
    <div class="">
        ...
        <div class="setup-screen" id="setupScreen">
             ...
             <div class="setup-section setup-level-selection">
                 <p class="setup-section-label">2. Elige un nivel (1-6):</p>
                 <div class="level-options-container" id="levelOptionsContainer">
                     <!-- Botones de nivel se poblarán con JS -->
                 </div>
             </div>
             <hr class="setup-divider">
             <div class="setup-section setup-category-selection">
                 <p class="setup-section-label">3. Elige una categoría:</p>
                 <div class="category-options-container" id="categoryOptionsContainer">
                     <!-- Botones de categoría se poblarán con JS -->
                 </div>
             </div>
             <hr class="setup-divider">
             ...
             <p class="setup-note">(Las preguntas se seleccionarán aleatoriamente<span id="filterSelectionNote"></span>)</p>
        </div>
