<div class="row padding-1 p-1">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $tutor?->name) }}" id="name" placeholder="Entra el nombre del tutor" required>
