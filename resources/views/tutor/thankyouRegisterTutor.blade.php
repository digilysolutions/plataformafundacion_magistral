                        ...
                        <div class="d-flex align-items-center auth-content">
                           <div class="col-lg-7 align-self-center">
                              <div class="p-3">
                                 ...
                                 <h2 class="mt-3 mb-0">¡Solicitud de Registro Exitoso!</h2>
                                 <p class="cnf-mail mb-1">Gracias por tu solicitud en nuestro sitio. Hemos enviado un correo a la dirección proporcionada. Por favor, revisa tu bandeja de entrada y sigue las instrucciones para verificar tu cuenta.</p>
