<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="activated" class="form-control @error('activated') is-invalid @enderror" value="{{ old('activated', $person?->activated) }}" id="activated" placeholder="Activated">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="tracking_code" class="form-control @error('tracking_code') is-invalid @enderror" value="{{ old('tracking_code', $person?->tracking_code) }}" id="tracking_code" placeholder="Tracking Code">
