...
Reporte Exámenes Diagnósticos - Centro Educativo Divina Pastora
@endsection
@section('css')
<style>
...
<h1>Reporte Exámenes Diagnósticos - Centro Educativo Divina Pastora</h1>

<!-- =========================== -->
<!-- === RESUMEN DIAGNÓSTICO === -->
<!-- =========================== -->
<h2 class="section-title">Resumen Exámenes Diagnósticos</h2>
<div class="contenedor-fichas">
    <div class="ficha summary-specific">
        <h2>Totales Diagnósticos (9no Grado)</h2>
        <ul>
            <li>Items Resueltos (Diagnósticos): <strong>45</strong></li>
            <li>Items No Resueltos (Diagnósticos): <strong>20</strong></li>
        </ul>
    </div>
</div>
