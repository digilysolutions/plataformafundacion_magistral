                ...
                <div class="form-row align-items-center">
                    <div class="col-auto">
                        ...
                        <select class="form-control mb-2" id="exam_type_fake" name="exam_type_fake">
                            ...
                            <option value="items">Nivel ITEMS</option>
                            <option value="pisa">Prueba PISA</option>
                            <option value="nacional">Pruebas Nacionales</option>
                            <option value="diagnostico">Exámenes Diagnósticos</option>
                        </select>
                    </div>
                    <div class="col-auto">
                                                    ...
                                                    <li>
                                                        ...
                                                        @else
                                                            {{-- Botón para solicitar certificado (pendiente) --}}
                                                             <button type="button" class="btn btn-sm btn-warning disabled">Solicitar Certificado</button>
                                                        @endif
                                                    </li>
                                                @endforeach
                                             </ul>
