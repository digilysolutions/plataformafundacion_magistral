<div class="row padding-1 p-1">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" name="code" class="form-control " required value="{{ old('code', $district?->code) }}"
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
            value="{{ old('name', $district?->name) }}" id="name" placeholder="Nombre" required>
        <div class="help-block with-errors"></div>
    ...
    <div class="form-group col-md-4">
        ...
        <select id="regional_id" name="regional_id" class="form-control" required>
            ...
            @foreach ($regionals as $regional)
                <option value="{{ $regional->id }}" @if ($regional->id == $district->regional_id) select @endif>
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
            value="{{ old('phone', $district?->phone) }}" id="phone" placeholder="Teléfono">
        <div class="help-block with-errors"></div>
        {!! $errors->first('mail', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
    </div>
    <div class="form-group col-md-6">
        ...
        <input type="text" id="mail" name="mail" class="form-control @error('mail') is-invalid @enderror"
            value="{{ old('mail', $district?->mail) }}" id="mail" placeholder="Correo">
        <div class="help-block with-errors"></div>
    ...
    <div class="form-group col-md-12">
        ...
        <textarea type="text" name="address" class="form-control @error('address') is-invalid @enderror" id="address"
            placeholder="Dirección">{{ old('address', $district?->address) }}</textarea>
